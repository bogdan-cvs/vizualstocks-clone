...
export default function ProfitabilityChart({ data, period }: Props) {
  ...
  return (
    <ResponsiveContainer width="100%" height="100%">
      <BarChart data={chartData}>
        ...
        <Bar dataKey="grossProfit" name="Gross Profit" fill="#3b82f6" radius={[2, 2, 0, 0]} />
        <Bar dataKey="operatingIncome" name="Operating Income" fill="#22c55e" radius={[2, 2, 0, 0]} />
        <Bar dataKey="netIncome" name="Net Income" fill="#a855f7" radius={[2, 2, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  );
}
